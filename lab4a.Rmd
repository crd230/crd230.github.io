...
<p class="comment">**Exercise**: Instead of encampments per area, map encampments per population *tpop*.  What is the correlation between neighborhood encampments per population and percent black? What about percent Hispanic?</p> 
