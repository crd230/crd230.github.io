...
```{r warning=FALSE, message=FALSE}
#calcuate the area of the tracts.  I promise I will explain why were doing this a little later. 
ca.tracts <- mutate(ca.tracts, tarea = as.numeric(st_area(ca.tracts)))
...
If we use `left_join()` to merge *medhval* from *ca.mhval* into *sac.city.tracts.c*, we get an error
